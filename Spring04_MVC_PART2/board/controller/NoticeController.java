...
public class NoticeController {
	...
	public FileSystemResource noticeDownload(
		...
		FileSystemResource downFile 
			= new FileSystemResource(readFolder + "/" + rfname);
	...
	public ModelAndView noticeModify(
		...
		if(sessionMember != null
				&& userId.equals(sessionMember.getUserId())) {
			
			Map<String, Object> commandMap = 
					noticeService.selectNoticeDetail(nIdx);
